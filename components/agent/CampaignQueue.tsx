  ...
  return (
    <div className="flex flex-col gap-2">
      ...
      {queue.map(({ campaign, videoCount, status }) => {
        ...
        return (
          <div key={campaign.id} className="bg-[var(--surface)] rounded-xl border border-[var(--border)] p-3 relative">
            <button
            ...
            <div className="flex items-start gap-2 mb-2 pr-5">
              <div className="flex-1">
                <p className="font-semibold text-[14px] text-[var(--text)]">{campaign.name}</p>
